...
public class AutonRunnable extends CommandGroup {
  ...
  public AutonRunnable(Position position, boolean doesShoot) {
    ...
    if (position == Position.CENTER) {
      addSequential(
          new DriveStraightTrapezoid(false, 0.7, 1.1, DriveStraightTrapezoid.Direction.FORWARD));
      addSequential(new DriveStraightTrapezoid(false, 0.5, 0.7,
      ...
      addSequential(
          new DriveStraightTrapezoid(false, 0.4, 2, DriveStraightTrapezoid.Direction.FORWARD));
    } else {
      ...
      addSequential(
          new DriveStraightTrapezoid(false, 1, 0.1, DriveStraightTrapezoid.Direction.FORWARD));// move
                                                                                               // forward
                                                                                               // enough
                                                                                               // to
                                                                                               // turn
      addSequential(new TurnTrapazoid(false, 0.4, 0.16, turnDirection));// turn
                                                                        ...
                                                                        // peg
      addSequential(
          new DriveStraightTrapezoid(false, 0.4, 0.5, DriveStraightTrapezoid.Direction.FORWARD));// move
                                                                                                 // halfway
                                                                                                 // to
                                                                                                 // peg
      ...
      addSequential(
          new DriveStraightTrapezoid(false, 0.4, 0.5, DriveStraightTrapezoid.Direction.FORWARD));// move
                                                                                                 // to
                                                                                                 // peg
      addSequential(new DriveStraightTrapezoid(false, 0.4, 0.5,
          DriveStraightTrapezoid.Direction.ANTIFORWARD));// reverse
                                                         // off
                                                         // peg
      addSequential(new TurnTrapazoid(false, 0.4, turnTimeToGoal, turnDirection));// turn
                                                                                  // to
                                                                                  // goal
      addSequential(new DriveStraightTrapezoid(false, 0.4, timeToGoal,
          DriveStraightTrapezoid.Direction.FORWARD));// move
                                                     // to
                                                     // goal
      if (doesShoot) {
