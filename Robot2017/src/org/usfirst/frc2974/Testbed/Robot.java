...
import org.usfirst.frc2974.Testbed.autoncommands.AutonShoot;
...
public class Robot extends IterativeRobot {
	...
	public void robotInit() {
		...
		SmartDashboard.putNumber("Climber Hold", 0.1);
	}
	...
	private void createAutonomousChooser() {
		...
		autoChooser.addObject("MoveForward", new DriveStraightTrapezoid(false, 0.7, 1, DriveStraightTrapezoid.Direction.FORWARD));
	...
	public void createTestButtons() {
		...
		SmartDashboard.putData("AutoShoot", new AutonShoot(5));
	}
