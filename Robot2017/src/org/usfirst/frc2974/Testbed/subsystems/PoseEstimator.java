...
public class PoseEstimator extends Subsystem implements PoseProvider {
  ...
  public static final double distancePerPulse = 0.0005652; // Original value 0.0005814; //Pracice
                                                           // bot
  ...
  public synchronized void updatePose() {
    ...
    /*
     * double sr = encoderRight.getDistance() - positionRightWheel; double sl =
     * encoderLeft.getDistance() - positionLeftWheel; double s; boolean goesLeft = sl < sr;
     * if(goesLeft){ s = 1.5*sl; }else{ s = 1.5*sr; }
     * 
