	...
	private enum State {
		ACC {
			...
			public void run(TurnTrapazoid d) {
				...
				Robot.drivetrain.setSpeeds(d.direction.directionValue * power,
					-d.direction.directionValue * power);
			}
		},
		CONST {
			...
			public void run(TurnTrapazoid d) {
				...
				Robot.drivetrain.setSpeeds(d.direction.directionValue * vmax,
					-d.direction.directionValue * vmax);
			}
		},
		DEC {
