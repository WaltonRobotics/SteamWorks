...
public class DriveStraightByEncoder extends Command {
	...
	public DriveStraightByEncoder(boolean isDashboard, double distance, double speed,
		double acceleration) {
	...
	protected void initialize() {
		...
		System.out
			.println(String.format("Distance=%f, Speed=%f, Accel=%f", distance, speed, acceleration));
