...
import org.usfirst.frc2974.Robot2017.controllers.PoseProvider;
...
public class PoseEstimator extends Subsystem implements PoseProvider {
	...
	public PoseEstimator() {
		...
		synchronized (this) {
			// 0.0024936392
			/*
			 * The commented out numbers are for the testbed
			 */
			// encoderLeft.setDistancePerPulse(0.0003979673);
			// encoderRight.setDistancePerPulse(-0.0003979673);
			encoderLeft.setDistancePerPulse(0.000487705024509);
			encoderRight.setDistancePerPulse(-0.000487705024509);
		}
	...
	public synchronized void updatePose() {
		...
		// CSVWriter.getInstance("PoseEstimator_position").write(positionLeftWheel,
		// positionRightWheel);
	}
