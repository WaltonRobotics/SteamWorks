...
public class MotionPathStraight extends MotionProvider {
	...
	public Motion getMotion(double time) {
		...
		Motion motion = new Motion(initialMotion.position.left + pos, vel, acc, initialMotion.position.right + pos, vel,
				acc, time > t3);
	...
	public String toString() {
		...
		return String.format(
				"Calculated path: t0=%3.1f, t1=%3.1f, t2=%3.1f, t3=%3.1f, l0=%5.3f, l1=%5.3f, l2=%5.3f, l3=%5.3f", t0,
				t1, t2, t3, l0, l1, l2, l3);
