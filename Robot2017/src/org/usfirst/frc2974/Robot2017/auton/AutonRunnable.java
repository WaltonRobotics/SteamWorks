package org.usfirst.frc2974.Robot2017.auton;
...
import org.usfirst.frc2974.Robot2017.autoncommands.DriveDiffTrapezoid.DiffDirection;
import org.usfirst.frc2974.Robot2017.autoncommands.TurnTrapazoid.Direction;
...
public class AutonRunnable extends CommandGroup {
    ...
    public  AutonRunnable(Position position, boolean doesShoot) {
    	...
    	if(position == Position.CENTER){
        	...
        	addSequential(new TurnTrapazoid(false, 0.4,0.16,turnDirection));//turn opposite angle of peg
        	addSequential(new DriveStraightTrapezoid(false, 0.4, 0.5,DriveStraightTrapezoid.Direction.FORWARD));//move halfway to peg
        	addSequential(new TurnTrapazoid(false, 0.4,0.16,antiTurnDirection));//turn to peg
        	...
        	addSequential(new TurnTrapazoid(false, 0.4,turnTimeToGoal,turnDirection));//turn to goal
