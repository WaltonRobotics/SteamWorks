...
public class Drive extends Command {
    ...
    public double getLeftThrottle() {
    	if(Math.abs(Robot.oi.gamepad.getLeftY()) < 0.3) {
    		return 0;
    	}
    	return Robot.oi.gamepad.getLeftY();
    }

    public double getRightThrottle() {
    	if(Math.abs(Robot.oi.gamepad.getRightY()) < 0.3) {
    		return 0;
    	}
    	return Robot.oi.gamepad.getRightY();
    ...
    protected void execute() {
    	...
    	if(Robot.oi.shiftDown.get()) Robot.drivetrain.shiftDown();
    	if(Robot.oi.shiftUp.get()) Robot.drivetrain.shiftUp();
